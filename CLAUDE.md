...
- S1、S2、S3、S4、S6 PRD 已存在；Phase 1 已完成 T03A–T03D（S3 练习闭环）、T04/T04A/T04B（S4 错题归档、Schema 与错题改错前端闭环，含 migration v6 与 S4 API）、T05 回流规则、T06 S6 家长观察 PRD、T06A 家长报告生成、T06B 家长报告推送和 T07 S1 时间线扩展。下一门禁为 Phase 1-T08：本机配置中心与连接验收；T08 尚未实现，S5/S7 仍按各自门禁等待。
