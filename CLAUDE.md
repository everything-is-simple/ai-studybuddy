...
- S1、S2、S3、S4、S6 PRD 已存在；Phase 1 已完成 T03A–T03D（S3 练习闭环）、T04/T04A/T04B（S4 错题归档、Schema 与错题改错前端闭环，含 migration v6 与 S4 API）、T05 回流规则、T06 S6 家长观察 PRD、T06A 家长报告生成、T06B 家长报告推送和 T07 S1 时间线扩展。下一门禁为 Phase 1-T08：本机配置中心与连接验收；T08 之后为 T09A–T09E 学生端产品化界面（学期向导、每日首页、课表完善、全局导航、历史归档）；T08 尚未实现，S5/S7 仍按各自门禁等待。
...
- S1 时间线：T07 已完成，考试工作台可读取当前课程近期活动；下一门禁为 T08 本机配置中心与连接验收的独立计划、审查和用户明确批准。
- 学生端产品化：T09A–T09E 已登记路线（学期创建/选择、每日首页、课表完善、全局导航 E2E、历史归档），均在 T08 之后按各自门禁执行；T08 完成 = 功能核心完成，T09D 完成 = 学生端可交付 MVP。
- S7：Phase 1.5 触发。
