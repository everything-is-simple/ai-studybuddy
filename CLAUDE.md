...
- S1、S2、S3、S4、S6 PRD 已存在；Phase 1 已完成 T03A–T03D（S3 练习闭环）、T04/T04A/T04B（S4 错题归档、Schema 与错题改错前端闭环，含 migration v6 与 S4 API）、T05 回流规则、T06 S6 家长观察 PRD、T06A 家长报告生成、T06B 家长报告推送、T07 S1 时间线扩展和 T08 本机配置中心与连接验收。下一门禁为 Phase 1-T09A：学期创建、选择与切换；T09A–T09E 是学生端产品化界面路线（学期向导、每日首页、课表完善、全局导航、历史归档），S5/S7 仍按各自门禁等待。
...
- 学生端产品化：下一门禁为 T09A 学期创建/选择/切换；T09A–T09E 已登记路线（学期创建/选择、每日首页、课表完善、全局导航 E2E、历史归档），均按各自门禁执行；T08 完成 = 功能核心完成，T09D 完成 = 学生端可交付 MVP。
- S7：Phase 1.5 触发。
