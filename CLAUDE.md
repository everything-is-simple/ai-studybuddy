...
- S1、S2、S3 PRD 已存在；Phase 1-T03A 实施计划已创建并自审，但 S3 Schema/API/业务代码尚未开始，S4–S7 仍未触发。
...
- S3：PRD 已创建；T03A 数据库与 Schema 计划已创建并自审，仍需用户明确批准后才能修改 migration、Schema、测试、类型或业务代码。
- S4：等 S3 MVP 完成后触发。
- S5：Phase 2 触发。
