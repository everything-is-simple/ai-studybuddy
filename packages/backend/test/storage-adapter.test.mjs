...
test("StorageAdapter throws when getting or deleting a missing key", async (t) => {
  ...
  await assert.rejects(adapter.get("semesters/missing/files/common/00000000-0000-4000-8000-000000000000.txt"), StorageKeyNotFoundError);
  await assert.rejects(adapter.delete("semesters/missing/files/common/00000000-0000-4000-8000-000000000000.txt"), StorageKeyNotFoundError);
});
