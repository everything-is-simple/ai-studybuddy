...
const AI_PROVIDER_PRESETS: readonly AiProviderPreset[] = [
  // === 国内主流 ===
  {
    ...
    requiresBaseUrl: false, maxBaseUrls: 1,
  },
  {
    id: 'kimi', displayName: 'Kimi（月之暗面）', group: 'mainland', protocol: 'openai-compatible', availability: 'available',
  ...
  },
  {
    ...
    baseUrl: 'https://open.bigmodel.cn/api/paas/v4', defaultModel: 'glm-4-flash',
  ...
  // === 国外主流 ===
  {
    id: 'openai', displayName: 'OpenAI ChatGPT', group: 'international', protocol: 'openai-compatible', availability: 'available',
  ...
  {
    id: 'anthropic', displayName: 'Anthropic Claude', group: 'international', protocol: 'openai-compatible', availability: 'available',
  ...
  {
    id: 'gemini', displayName: 'Google Gemini', group: 'international', protocol: 'openai-compatible', availability: 'available',
    baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai', defaultModel: 'gemini-2.0-flash-exp',
  ...
  {
    id: 'relay-1', displayName: '中转站 1', group: 'relay', protocol: 'openai-compatible', availability: 'available',
    baseUrl: '', defaultModel: '',
    modelSuggestions: [],
    description: '自定义中转站，OpenAI 兼容接口。填写 API Key 和至少一个请求地址；可以多填几个备用地址，测试时逐个尝试，用第一个通的。',
    requiresBaseUrl: true, maxBaseUrls: 4,
  },
  {
    id: 'relay-2', displayName: '中转站 2', group: 'relay', protocol: 'openai-compatible', availability: 'available',
    baseUrl: '', defaultModel: '',
    modelSuggestions: [],
    description: '自定义中转站，OpenAI 兼容接口。填写 API Key 和至少一个请求地址；可以多填几个备用地址，测试时逐个尝试，用第一个通的。',
    requiresBaseUrl: true, maxBaseUrls: 4,
  ...
  {
    id: 'relay-3', displayName: '中转站 3', group: 'relay', protocol: 'openai-compatible', availability: 'available',
    baseUrl: '', defaultModel: '',
    modelSuggestions: [],
    description: '自定义中转站，OpenAI 兼容接口。填写 API Key 和至少一个请求地址；可以多填几个备用地址，测试时逐个尝试，用第一个通的。',
    requiresBaseUrl: true, maxBaseUrls: 4,
