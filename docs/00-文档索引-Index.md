...
| 版本 | 日期 | 变更 |
| ---- | ---- | ---- |
| v2.61 | 2026-07-28 | 同步用户重新开放 Phase 3 高权重必做项的恢复计划：仅纳入 T02-R1、T02-R2、T04-1～T04-3、T02-R3、T05-1～T05-3、T02-R4、T02-R6；计划待独立审查和逐项实施，不表示 T02、Phase 3、真实恢复、生产上线或用户电脑验收完成。 |
