...
| S3 限时练习 | `subsystems/S3-限时练习子系统PRD-PracticeRunner.md` | 🟡 触发条件已满足，等待 Phase 1-T03 计划批准后创建 | S2 MVP 完成后触发 |
...
1. 重读 S1/S2 PRD 与 T09 验收结论；
2. 先执行 `04` 中的 Phase 1-T10、T11、T02；
3. 到 Phase 1-T03 且计划获批后，再创建 S3 PRD；
4. S3 MVP 完成后才触发 S4 PRD。
