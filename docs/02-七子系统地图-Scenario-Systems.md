...
| S2 | 资料笔记 NoteBuilder | 课后整理资料 | 上传 PDF/文本/图片 | 笔记、重点、导图 | PDF.js、pdf-parse、PaddleOCR、react-markdown、KaTeX、Markmap | DeepSeek/Qwen 整理，GPT 兜底 |
...
| S5 | 期末冲刺 ExamCrammer | 考前冲刺 | 上传真题、限时模拟 | 真题解析、模拟卷、冲刺计划 | PDF/OCR、计时器、题库 | 教学解析、变题组卷、难题 GPT 兜底 |
