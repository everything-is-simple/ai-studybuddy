...
| S2 | 资料笔记 NoteBuilder | 课后整理资料 | 上传 PDF/文本/图片 | 笔记、重点、导图 | PDF.js、pdf-parse、PaddleOCR、react-markdown、KaTeX、Markmap | Kimi/Qwen 整理，GPT/Claude 兑底 |
...
| S5 | 期末冲刺 ExamCrammer | 考前冲刺 | 上传真题、限时模拟 | 真题解析、模拟卷、冲刺计划 | PDF/OCR、计时器、题库 | 教学解析、变题组卷、难题 GPT/Claude 兑底 |
| S6 | 家长观察 ParentWindow | 家长查看节奏 | 打开共享空间 | 完成状态、趋势、预警 | Web/PWA、图表库 | 可选生成周报摘要 |
