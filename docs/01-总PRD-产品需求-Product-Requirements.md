...
**版本**：v1.6
**日期**：2026-07-18
**状态**：Windows 单机产品基线；Phase 1 功能核心已完成，学生端可交付 MVP 仍需 T09A–T09D
...
截至 2026-07-18，S1/S2/S3/S4/S6 简版的业务闭环和 Phase 1-T08 本机配置中心已合入主线。T08 解决 Windows 当前用户加密配置、AI/SMTP/飞书连接测试、运行时热切换和降级启动；它代表“功能核心完成”，不等于学生端交互已经产品化。T09A–T09D 依次补齐学期创建/选择、每日首页、课程课表/考试目标和全局学生旅程，T09D 完成后才使用“学生端可交付 MVP”口径。
...
Phase 1 内部完成口径：T08 完成表示业务与配置功能核心闭环；T09A–T09D 是学生端产品化路线，当前只登记、尚未实施。T09E 的练习历史和学期归档属于可后置增强。
...
| OCR/ASR 运维复杂            | 先在外部 `I:\ai-studybuddy-composer` 调通；正式产品按 PDF 文本提取 → OCR → 视觉模型 → 手工校正分级降级，未通过 smoke test 不进主系统 |
