...
**版本**：v0.3
**日期**：2026-07-18
**状态**：T06/T06A/T06B 均已实现；T08 已提供 SMTP/飞书本机加密配置、连接测试和运行时切换；真实渠道 smoke 仍非常规验收依赖
...
| T08     | 本机加密配置、SMTP/飞书分别连接测试、运行时配置快照                | ✅ 已实现；不新增家长 Web 面板                         |
...
| 版本 | 日期       | 说明                                                                                                                                                                                                                                                                                   |
| ---- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v0.3 | 2026-07-18 | 同步 T08 配置中心完成事实：SMTP/飞书秘密由 Windows 当前用户加密保存、分渠道测试并通过运行时快照供报告 runner 使用；S6 仍无家长登录或 Web 面板                                                                                                                                          |
