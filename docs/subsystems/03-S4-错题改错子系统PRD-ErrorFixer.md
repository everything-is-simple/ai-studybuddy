...
**版本**：v0.4
**日期**：2026-07-17
**状态**：Phase 1 轻量 PRD 已创建；T04A Schema 与归档、T04B 错题改错前端闭环和 T05 回流规则均已完成；S6 家长观察 PRD 已创建，下一门禁为 T06A S6 家长报告生成
...
S5、S7 不因本 PRD 创建而自动获得实施授权。S6 已创建家长观察 PRD，但 T06A/T06B 仍需各自独立计划；S6 只允许读取 S4 的脱敏聚合，不读取题目、答案、学生作答或错因正文。
