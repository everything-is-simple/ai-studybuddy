...
**版本**：v0.2
**日期**：2026-07-20
**状态**：Phase 2-T01 S5 PRD、T02 模拟考 Schema 与生成、T03 模拟考前端和 T04 临考速背均已完成主线复验并推送 `origin/master`；T05–T06 仍必须分别独立计划、审查和获批后实施
...
> 本节只描述概念对象，不代表 T01 创建 Schema。T02–T04 已在各自独立计划中确定实现契约；T05–T06 的表结构、迁移版本、DTO 和 API 仍须在各自计划中确定。
