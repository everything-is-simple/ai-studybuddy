...
**版本**：v0.05
**日期**：2026-07-18
**状态**：S1 核心、Phase 1-T11 考试确认/任务闭环和 T07 当前课程时间线已实现；下一门禁为 T09A 学期创建、选择与切换
...
| Phase 1-T09A | 学期创建、选择与切换；向导含课表识别预览和一次确认 | ⏳ 下一门禁，需独立计划与用户批准 |
| Phase 1-T09B/T09C | 每日学习首页；已创建学期的课程、课表与考试目标完善 | ⏳ 已登记路线，未实施 |
