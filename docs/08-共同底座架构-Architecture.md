...
| Provider | 倍率区间 | 适用场景 | 注意 |
|---|---|---|---|
| **GPT 中转** | 0.02–0.10（常用 0.06–0.08） | 日常笔记整理、出题、主观批改 | 0.02 档可能不稳，生产建议 0.06–0.08 |
| **Claude 中转** | 0.10–0.15 | 复杂推理、难题解析、代码生成 | 能力强，适合 S5 期末冲刺难题 |
| **国产免费额度** | 免费（GLM/Kimi 签到/申请） | 开发测试阶段，不用于生产 | 额度有上限，生产稳定性不如付费 |
| **国产官方直连** | 约 0.1 倍率 | 中转全挂时最终兜底 | 始终可用，保证系统不完全停摆 |

**共用账号风险**：学生名义申请的低价/免费账号有时与他人共用，**API 请求内容可能被中转方或共用方看到**。生产环境处理真实学习数据时，建议走独立付费账号，避免学生笔记、试题内容外泄。
