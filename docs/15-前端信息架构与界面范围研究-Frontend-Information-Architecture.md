...
- 不因本研究文档继续扩展已完成的 S5 MVP、S7 或任何尚未批准的学生端页面。
...
| Phase 1.5 | 录音上传/转写页 | 当前未计入；若 S7 获批则在现有基线上 +1 | S7 尚未触发，不阻塞已完成的 Phase 2。 |
...
- 当前 Phase 2 完成后共有 20 页；Phase 1.5/S7 与 Phase 3 均不是当前实施范围。
...
5. Phase 3 暂缓；不为 S6 创建家长登录或 Web 面板，S7 仍等待独立门禁。
