...
| Phase 1   | 跑通完整学习闭环（S1+S2+S3+S4+S6 简版） | 🔄 进行中（T00/T10/T02/T03/T11/T03A/T03B/T03C/T03D/T04/T04A/T04B/T05/T06/T06A/T06B/T07/T08/T09A ✅；T09B ✅；T09C 分支验证完成、待主线集成；T09D–T09E 未启动） |
...
**前置条件**：Phase 0.8 T09 已通过。S1/S2/S3/S4/S6 PRD 与 Phase 1-T00–T09A 对应范围已完成；S5/S7 仍未触发。T09B 已 fast-forward 合入 `master` 并完成主线复验；T09C 已完成任务分支实现、独立复审与分支验证，等待按固定 fast-forward 流程集成主线；T09D–T09E 仍未开始，进入任一后续任务前必须重新完成各自的独立计划、审查和用户明确批准。
...
| 22 | Phase 1-T09C：课程课表与考试目标完善 | 🔄 | 用户已于 2026-07-18 明确批准；任务分支实现、独立复审与分支验证均已完成，等待按固定 fast-forward 流程集成 `master`，尚未报告为主线完成。范围固定为已创建学期的课程名称、完整周课表条目维护及考试名称/日期/目标与已确认倒计时，不含 T09D/T09E |
...
| T09C | `.plans/phase1-t09c-course-schedule-exam-goals-plan.md` | 独立计划和复审已完成，用户已于 2026-07-18 明确批准；任务分支实现、独立复审和分支验证已完成，等待按固定 fast-forward 流程集成 `master`，尚未推送 `origin/master`；仍不得与 T09A/T09B 混写实现 |
